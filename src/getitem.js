...
function getitem(
  ...
  function createRow(tableData) {
    if (
      tableData.payment_item_cnt_ec_sum == null ||
      tableData.payment_item_cnt_real_sum == null
    ) {
      console.log("Null Data");
    } else {
      document.getElementById(
        "ec-amt"
      ).innerHTML = `${tableData.payment_item_cnt_ec_sum.toLocaleString()} 点`;
      document.getElementById(
        "real-amt"
      ).innerHTML = `${tableData.payment_item_cnt_real_sum.toLocaleString()} 点`;
    }
  }
}
